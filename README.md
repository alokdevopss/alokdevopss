<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=220&section=header&text=Alok%20Ranjan&fontSize=80&animation=fadeIn&fontAlignY=30&desc=Senior%20DevOps%20Engineer%20%7C%20SRE%20Practices%20%20&descAlignY=55&descAlign=50%22%20alt=%22Header%22"/>

## 👋 Hi, I'm Alok Ranjan

🚀 Senior DevOps Engineer specializing in building scalable, secure, and automated infrastructure.<br>
📊 Experienced in optimizing cloud costs, automating deployments, and improving system reliability in production environments.

I design and manage production-ready cloud environments with strong focus on:
- High Availability  
...
Automated cloud cost analysis and reporting system to optimize AWS & GCP spending.

🔹 **Kubernetes Monitoring Stack**  
Production-grade monitoring setup using Prometheus, Grafana, and alerting mechanisms.

🔹 **Automated Backup & Disaster Recovery System**  
Scripted backup automation for cloud databases with secure storage integration.

🔹 **CI/CD Pipeline Automation**  
End-to-end deployment automation for containerized applications using Jenkins.
